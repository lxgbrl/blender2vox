...
class VoxPalette:
    ...
    def get_rgba_chunk(self) -> VoxChunk:
        ...
        Note: In VOX format, colors[0-254] map to palette index[1-255].
        The first entry (index 0) is unused but still stored.
        """
        content = b''
        # Write 256 RGBA values (1024 bytes)
        # Colors 0-254 from file map to palette index 1-255
        for i in range(256):
